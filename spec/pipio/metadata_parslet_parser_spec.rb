describe Pipio::MetadataParsletParser do
  context '#parse' do
    it "finds my screen name" do
      ...
      metadata = Pipio::MetadataParsletParser.new(first_line_of(file)).parse
